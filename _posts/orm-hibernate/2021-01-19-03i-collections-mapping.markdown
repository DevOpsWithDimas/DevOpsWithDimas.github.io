...
image_path: /resources/posts/orm-hibernate/03i-collection-mapping
downloads: []
---
...
![erd]({{ page.image_path | prepend: site.baseurl }}/erd-asvalue.png)
...
![select-table]({{ page.image_path | prepend: site.baseurl }}/select-tables-asvalue.png)

## Element Collection As Type

Berikut adalah perancangan tabelnya:

![erd]({{ page.image_path | prepend: site.baseurl }}/erd-astype.png)
...
![select-tables]({{ page.image_path | prepend: site.baseurl }}/select-tables-astype.png)
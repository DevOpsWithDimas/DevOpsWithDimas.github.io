...
5. **Install Sonatype nexus-oss**, untuk menginstall nexus-oss kita juga udah pernah bahas di artikel sebelumnya, [baca disini]({% post_url docker/03-registries/2021-04-24-03c-using-nexus-oss %}) 

...
Jika temen-temen masih ingat pada materi sebelumya tentang [persistence volume]({% post_url docker/05-volume/2021-06-01-06-silabus-docker-volume %}), kita tidak disarankan untuk menyimpan data ke dalam suatu container karena 
